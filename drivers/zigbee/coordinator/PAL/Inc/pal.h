...
#define ID_PIOD   (14) /**< \brief Parallel I/O Controller C (PIOC) */
#define ID_SPI    (21) /**< \brief Serial Peripheral Interface (SPI) */
#define ID_TC2    (25) /**< \brief Timer/Counter 2 (TC2) */
#define EXTI_Line_All16       ((uint32_t)0xFFFF)  /*!< External interrupt line 16 all */
...
extern "C" {
#endif
extern uint8_t event_processed;
/**
...
#if PAL_TYPE == ATMEGA256RFR1 || PAL_TYPE == ATMEGA256RFR2
/**
...
#define PAL_RX_LNA_HIGH()                  RX_LNA_HIGH()
#define PAL_RX_LNA_LOW()                  RX_LNA_LOW()
...
#else
#define ASSERT(expr) //#define ASSERT(condition, dbgCode) {if(condition){}}
#endif /* (DEBUG > 0) */
/** @endcond */
