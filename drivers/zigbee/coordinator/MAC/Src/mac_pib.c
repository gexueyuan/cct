 ...
 *
 * $Id: mac_pib.c 30017 2012-01-04 03:05:10Z yogesh.bellan $
 *
...
#if (MAC_INDIRECT_DATA_FFD == 1)
         case macTransactionPersistenceTime:
            if (NwkState == NWK_MODULE_ID_JOIN_REQ)
                NwkJoinReqState = JOIN_REQ_SET_TRANSACTION_TIME_STATE;
            else if (NwkState == NWK_MODULE_ID_FORMATION)
                NwkFormationState = NWK_FORMATION_SET_TRANSACTION_TIME_STATE;
