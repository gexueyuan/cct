...
/* Exported types ------------------------------------------------------------*/
typedef enum {SLAVE = 0, MASTER = !SLAVE} SPI_Status;
/* Exported constants --------------------------------------------------------*/
...
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
extern void spi_Interface_Init(SPI_Status SPI_Mode);
extern void spiSwitch(SPI_Status SPI_Mode);
extern void GPIO_Configuration(uint16_t SPIy_Mode);
