 ...
 *
 * $Id: tal.h 31434 2012-03-23 11:40:10Z viswanadham.kotla $
 *
...
typedef enum
{
    ...
    NWK_DATA_REQUEST_N,
    NWK_DATA_IND_FORWARD_N,
    NWK_DATA_RESPONSE_N,
    NWK_CMD_ROUTE_REQUEST_N, /**< ZigBee spec r17, 3.4.1 */
    NWK_CMD_ROUTE_REQUEST_RELAY_N,
    NWK_CMD_ROUTE_REPLY_N, /**< ZigBee spec r17, 3.4.2 */
    NWK_CMD_ROUTE_REPLY_RELAY_N,
    NWK_CMD_NETWORK_STATUS_N, /**< ZigBee spec r17, 3.4.3 */
    NWK_CMD_LEAVE_N, /**< ZigBee spec r17, 3.4.4 */
    NWK_CMD_LEAVE_IND_FORWARD_N,
    NWK_CMD_ROUTE_RECORD_N, /**< ZigBee spec r17, 3.4.5 */
    NWK_CMD_ROUTE_RECORD_RELAY_N,
    NWK_CMD_REJOIN_REQUEST_N, /**< ZigBee spec r17, 3.4.6 */
    NWK_CMD_REJOIN_RESPONSE_N, /**< ZigBee spec r17, 3.4.7 */
    NWK_CMD_LINK_STATUS_N, /**< ZigBee spec r17, 3.4.8 */
    NWK_CMD_NETWORK_REPORT_N, /**< ZigBee spec r17, 3.4.9 */
    NWK_CMD_NETWORK_UPDATE_N,  /**< ZigBee spec r17, 3.4.10 */
    NWK_DATA_BROADCAST_N,
    NWK_DATA_BROADCAST_RELAY_N
#ifdef ENABLE_RTB
    ,
    /* RTB Message Types */
...
#endif
{
    ...
    //NwkCmdIdentifier_t NwkMsg_type;
    //uint8_t nsduHandle;
 ...
 * and Note 5 in chapter "Register Summary"
 */
#define CONF_REG_WRITE()   do {    \
        pal_trx_reg_write(RG_PART_NUM, ATMEGA128RFA1_PART_NUM); \
    } while(0)
