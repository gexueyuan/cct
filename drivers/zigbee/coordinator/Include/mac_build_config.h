 ...
 */
     ...
     */
    #define MAC_ASSOCIATION_INDICATION_RESPONSE     (0)//1
    #define MAC_ASSOCIATION_REQUEST_CONFIRM         (0)//1
    #define MAC_BEACON_NOTIFY_INDICATION            (0)//1
    #define MAC_DISASSOCIATION_BASIC_SUPPORT        (0)
    #define MAC_DISASSOCIATION_FFD_SUPPORT          (0)
    #define MAC_GET_SUPPORT                         (0)//1
    #define MAC_INDIRECT_DATA_BASIC                 (0)//1
    #define MAC_INDIRECT_DATA_FFD                   (0)//1
    ...
    #define MAC_RX_ENABLE_SUPPORT                   (0)//1
    ...
    #define MAC_START_REQUEST_CONFIRM               (0)//1
#else
    /**
