 ...
 *
 * $Id: ieee_const.h 30789 2012-02-10 10:06:09Z yogesh.bellan $
 *
 ...
 * @ingroup apiMacConst
 */
#define aMaxBeaconPayloadLength         (sizeof(NwkBeaconPayload_t))//(aMaxPHYPacketSize - aMaxBeaconOverhead)
 ...
 */
#define macBeaconPayloadLength_def      (sizeof(NwkBeaconPayload_t))
