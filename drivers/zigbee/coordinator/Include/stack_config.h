 ...
 *
 * $Id: stack_config.h 30715 2012-02-08 13:53:48Z yogesh.bellan $
 *
...
#define LARGE_BUFFER_SIZE                   (((MCPS_DATA_IND_SIZE + \
                                               aMaxMACPayloadSize + \
                                               LQI_LEN + ED_VAL_LEN + 12) / 4 + 1) * 4)//12是nwk需要的附加内容
...
#define LAST_STACK_TIMER_ID                 (MAC_LAST_TIMER_ID)
    ...
    #define NUMBER_OF_LARGE_STACK_BUFS      (6 + EXTRA_RTB_BUFFER +2)
#else
