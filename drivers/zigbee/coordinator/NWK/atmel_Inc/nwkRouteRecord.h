...
typedef struct PACK _NwkRouteRecordPayload_t
{
  ...
  NwkCmdIdentifier_t NwkCmdIdentifier;
...
typedef struct _NWK_RouteRecordRelay_t
{
  enum nwk_msg_code cmdcode;
  uint16_t MacDestAddress;
  uint8_t payloadSize;
  uint8_t *payload;
} NWK_RouteRecordRelay_t;

typedef struct _NWK_RouteRecordReq_t
{
  enum nwk_msg_code cmdcode;
  uint16_t MacDestAddress;
  uint8_t  *uartApp;
}NWK_RouteRecordReq_t;
/******************************************************************************
                               Prototypes section
 ******************************************************************************/
