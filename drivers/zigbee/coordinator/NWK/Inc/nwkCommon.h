...
//The minimum number of octets added by the NWK layer to an NSDU.2帧控制，2目的地址 2源地址 1半径 1序列号
#define nwkcMinHeaderOverhead 8U

//The size of the MAC header used by the ZigBee NWK layer.包括校验和 2帧控制，1序列号，2目的panid 2目的地址 2源地址
...
typedef uint8_t Rssi_t;//原是int8_t problem
